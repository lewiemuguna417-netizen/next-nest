...
This pull request includes the complete PAXFORM application required for the Senior Full-Stack Assessment.
The project integrates a full production-ready frontend deployed to Google Cloud Run along with authentication, routing, secure configuration, environment management, and UI workflows.

The full project directory from the PAXFORM environment has been included to demonstrate end-to-end implementation quality, architecture discipline, and production-grade deployment readiness.
